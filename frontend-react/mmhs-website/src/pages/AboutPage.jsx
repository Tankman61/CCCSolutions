  ...
  return (
      <div className="bg-gray-100 min-h-screen">
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  ...
                  <div key={index}
                       className="flex items-center bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
                    <div
                        className="bg-gradient-to-r from-blue-800 to-indigo-800 h-16 w-16 rounded-full flex items-center justify-center text-white font-bold text-xl">
                      {item.year}
                    </div>
                    <div className="ml-6">
        ...
        <div className="py-20 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-6">A Special Thanks</h2>
            ...
            <div className="flex flex-wrap justify-center gap-8">
              {[
                ...
                },
                {
                  ...
                  image: "https://media.licdn.com/dms/image/v2/C5603AQGWsDKiYJdxIQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1626640887337?e=1731542400&v=beta&t=zT-32kfQKSwhPOnLgd5nMKL8shWR9KPgtbhT9wJRmug"
                },
              ].map((teacher, index) => (
                  <div key={index}
                       className="w-64 text-center bg-gray-100 rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
                    <img src={teacher.image} alt={teacher.name}
                         className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"/>
                    <h3 className="text-2xl font-semibold mb-2">{teacher.name}</h3>
                    <p className="text-lg" dangerouslySetInnerHTML={{__html: teacher.role}}></p>
                  </div>
              ))}
            </div>
        ...
        <div className="bg-gray-100 py-20 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg text-center mb-10">
              We are grateful for the contributions of the following individuals who have helped contribute solutions to
              this website
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-8">
              {[
                ...
                {name: "John Liao", school: "Lo-Ellen Park S.S.", image: JohnLiao},
                  ...
                  <div key={index}
                       className="w-64 flex flex-col items-center bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
